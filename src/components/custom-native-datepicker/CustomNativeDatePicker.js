...
import {Animated, DatePickerAndroid, DatePickerIOS, Image, Keyboard, Modal, Platform, Text, TimePickerAndroid, TouchableHighlight, View} from 'react-native';
import Style from './style';
import Moment from 'moment';
import date_icon from "../../assets/date_icon";
...
class CustomNativeDatePicker extends Component {
    constructor(props) {
        super(props);
...
CustomNativeDatePicker.defaultProps = {
    mode: 'date',
    androidMode: 'default',
    date: '',
...
CustomNativeDatePicker.propTypes = {
...
export default CustomNativeDatePicker;
